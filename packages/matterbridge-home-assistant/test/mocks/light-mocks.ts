import { LightEntityColorMode } from '@home-assistant-matter-hub/devices';
import { HomeAssistantMatterEntity } from '@home-assistant-matter-hub/models';

export const lightMocks = {
  withBrightness: (id: number): HomeAssistantMatterEntity => ({
  ...
  withHsl: (id: number): HomeAssistantMatterEntity => ({
  ...
  withRgb: (id: number): HomeAssistantMatterEntity => ({
  ...
  withXY: (id: number): HomeAssistantMatterEntity => ({
  ...
  withTemperature: (id: number): HomeAssistantMatterEntity => ({
